...
class FetchUserRecipesStrategy {
  final AuthService _authService;
  static const _timeout = Duration(seconds: 15);

  FetchUserRecipesStrategy(this._authService);

  Future<List<Recipe>> execute(String userId,
      {int page = 1, int limit = 10}) async {
    AppLogger.debug('📦 FetchUserRecipesStrategy - page: $page, limit: $limit');
    ...
    AppLogger.api('GET /api/recipes/user/$userId?page=$page&limit=$limit');
